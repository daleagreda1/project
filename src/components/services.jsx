...
const Services = () => {
  return  <Section id="how-to-use">
    <div className="container">
        <Heading title="AI ON TOP!!!!!!"
            text="AI WILL MAKE THE WORLD A BETTER PLACE"
        />
        <div className="relative">
            ...
            rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
              ...
              <div className="relative z-1 max-w-[17rem] ml-auto">
                   <h4 className="h4 mb-4">DETU-CHAN Smartest AI</h4>
                   <p className="body-2 mb-[3rem] text-n-4">AI WILL CONQUER THE WORLD WHOOP! WHOOP!</p>
                   <ul className="body-2">
            ...
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              <div className="absolute inset-0">
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                   <h4 className="h4 mb-4">Ironman is the future</h4>
                   <p className="body-2 mb-[3rem] text-n-4">
                   PEEEEEEEEEW! PEWWWWWWWWWWW! PEEEEEW! app&apos; PEWWWWW!
                   </p>
                   </div>
                   <PhotoChatMessage/>
                   </div>
                    ...
                    <div className="py-12 px-4 xl:px-8">
                        ...
                        <p className="body-2 mb-[2rem] text-n-3">The World Best Video art generation</p>
                    <ul className="flex items-center justify-between">{brainwaveServicesIcons.map((item,index)=>(
                        <li 
                        key={index} 
